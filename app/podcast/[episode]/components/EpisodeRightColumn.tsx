// app/podcast/[episode]/components/main-page/EpisodeRightColumn.tsx
...
interface EpisodeRightColumnProps {
  hosts: string[];
}

export default function EpisodeRightColumn({ hosts }: EpisodeRightColumnProps) {
  return (
