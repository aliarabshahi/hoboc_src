...
import LatestLessonsArrowButton, { LatestLessonsSkeletonArrowButton } from "./LatestLessonsArrowButton";
  ...
  return (
    <div className="w-full mt-16">
      ...
      <div className="flex items-center justify-between mb-6 relative z-10">
        <h2 className="text-xl md:text-2xl font-bold text-hoboc-dark">جدیدترین درس ها</h2>
      ...
      <div className="grid gap-6 md:grid-cols-3 relative z-10 lg:pr-10">
        {visibleLessons.map((lesson, idx) => (
          <div key={lesson?.id || idx}>
            {!lesson ? <LatestLessonsSkeletonCard /> : <LatestLessonsCard lesson={lesson} />}
          </div>
        ))}
      </div>
