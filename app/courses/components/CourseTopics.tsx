...
//       // Simulate hover effect by adding a class
//       element.classList.add("bg-hoboc/5");
//       setTimeout(() => {
//         element.classList.remove("bg-hoboc/5");
//       }, 1500);
...
//                   href={`#topic-${topic.id}`}
//                   onClick={(e) => handleTopicClick(e, String(topic.id))}
//                   className="flex items-center gap-3 px-4 py-3 hover:bg-hoboc/5 transition-colors duration-200 group focus:outline-none"
//                 >
//                   {topic.logo_file && (
//                     <div className="flex-shrink-0 bg-white p-1 rounded-lg border border-gray-200 group-hover:border-hoboc/30 transition-colors">
//                       <Image
